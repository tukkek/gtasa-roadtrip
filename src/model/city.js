...
class LosSantos extends City{
  ...
  visitcentral(){
    ...
    central.visit("Roboi's Food Mart (courier missions)",this.x,this.y)
  }
  ...
  visitwest(){
    ...
    west.visit("Roboi's Food Mart (courier missions)",this.x,this.y)
...
class SanFierro extends City{
  ...
  visitmain(){
    ...
    main.visit('Queens Hippy Shopper (courier missions)',this.x,this.y)
    ...
    main.visit('Hashbury Hippy Shopper (courier missions)',this.x,this.y)
...
class LasVenturas extends City{
  ...
  visitmain(){
    ...
    main.visit('Redsands East Burger Shot (courier missions)',this.x,this.y)
